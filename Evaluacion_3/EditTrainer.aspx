<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="EditTrainer.aspx.cs" Inherits="Evaluacion_3.EditTrainer" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid" runat="server" ID="divEdit">
        <div class="row">
            <div class="col-sm-12 mx-auto mt-5 w-50">
                <h1 class="mt-3">Edit Trainer </h1>
                ...
                <asp:Button ID="addTrainerBtn" CssClass="btn btn-success mt-5" OnClick="EditTrainerBtn_Click" runat="server" Text="Submit" />
            </div>
        </div>
    </div>
